...
class _RegisterPartnerState extends State<RegisterPartner> {
  ...
  String vatIDDropDownButtonValue = "CA";
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                alignment: Alignment.topLeft,
                child: Text(
                  'Create an account to continue as a Partner',
                  ...
                  children: [
                    Expanded(
                      child: DropdownButtonFormField(
                        ...
                        onChanged: (value) {
                          setState(() {
                            vatIDDropDownButtonValue = value;
                            print(value);
                          });
                        },
                        items: [
                  ...
                  : Container(
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: () async {
                          ...
                          var result = _auth.signUpWithEmailAndPasswordPartner(
                              _email.text,
                              _pass.text,
                              _firstName.text,
                              _lastName.text,
